...
const about = {
  ...
  info: [
    ...
    { fieldName: "Facebook", value: "Alhie Fikri" },
    { fieldName: "Nationality", value: "Indonesia" },
    { fieldName: "Email", value: "Alhiefikri12@gmail.com" },
    { fieldName: "Freelance", value: "Available" },
    { fieldName: "Language", value: "Indonesia, English" },
  ],
};
                      ...
                      <li key={index}>
                        <TooltipProvider delayDuration={100}>
                          <Tooltip>
                            ...
                            <TooltipContent className="w-[130px] text-center h-full bg-white text-primary rounded-xl">
